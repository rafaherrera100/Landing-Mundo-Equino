...
const testimonials = [
  ...
  { quote: "La IA me ahorra horas registrando ejemplares. Hablo, dicto los datos y la ficha queda lista. Para un criadero de 80 caballos es invaluable.", author: "Criador de Criollo Colombiano" },
...
export default function Testimonials({ variant }: { variant: ThemeVariant }) {
  ...
  return (
    <section className={`py-24 sm:py-32 ${theme.bgPrimary} ${variant === 'classic' ? 'text-amber-50' : variant === 'minimal' ? 'text-white' : 'text-emerald-50'}`}>
